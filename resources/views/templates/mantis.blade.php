...
<html lang="en">
  ...
  <body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="/home" class="b-brand text-primary">
                    ...
                    {{-- <img src="{{ asset('assets/templates/Mantis-Bootstrap-1.0.0/images/logo-icon.svg') }}" class="img-fluid" alt="logo"> --}}
                ...
                <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative" style="max-height: calc(100vh - 215px)">
                  <div class="list-group list-group-flush w-100">
                    <a class="list-group-item list-group-item-action">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="{{ asset('assets/templates/Mantis-Bootstrap-1.0.0/images/user/avatar-2.jpg') }}" alt="user-image" class="user-avtar">
                        </div>
                    ...
                    <a class="list-group-item list-group-item-action">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="{{ asset('assets/templates/Mantis-Bootstrap-1.0.0/images/user/avatar-1.jpg') }}" alt="user-image" class="user-avtar">
                        </div>
                        <div class="flex-grow-1 ms-1">
                    ...
                    <a class="list-group-item list-group-item-action">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="{{ asset('assets/templates/Mantis-Bootstrap-1.0.0/images/user/avatar-3.jpg') }}" alt="user-image" class="user-avtar">
                        </div>
                        <div class="flex-grow-1 ms-1">
                    ...
                    <a class="list-group-item list-group-item-action">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="{{ asset('assets/templates/Mantis-Bootstrap-1.0.0/images/user/avatar-4.jpg') }}" alt="user-image" class="user-avtar">
                        </div>
                        <div class="flex-grow-1 ms-1">
              ...
              <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
                <div class="dropdown-header">
                  <div class="d-flex mb-1">
                    <div class="flex-shrink-0">
                      <img src="{{ asset('assets/templates/Mantis-Bootstrap-1.0.0/images/user/avatar-2.jpg') }}" alt="user-image" class="user-avtar wid-35">
                    </div>
    ...
    {{-- <script src="{{ asset('assets/templates/Mantis-Bootstrap-1.0.0/js/plugins/apexcharts.min.js') }}"></script> --}}
    {{-- <script src="{{ asset('assets/templates/Mantis-Bootstrap-1.0.0/js/pages/dashboard-default.js') }}"></script> --}}
