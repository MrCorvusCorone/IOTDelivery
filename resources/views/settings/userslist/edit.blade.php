...
@section('mainContent')
    <div class="pc-container">
        <div class="pc-content">
            ...
            <!-- [ Main Content ] start -->
            <form action="/userslist/{{ $data['user']->id }}/edit" method="post" enctype="multipart/form-data">
                @method('patch')
                @csrf
                <div class="row mt-5">
                    {{-- Kolom Kiri-- start --}}
                                    ...
                                    <div class="col-md-12 col-xl-12">
                                        <div class="row mb-4">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control form-control-sm mt-1" placeholder="{{ $data['user']->name }}" name="name" id="name" value="{{ $data['user']->name, old('name') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-12">
                                                ...
                                                <input type="email" class="form-control form-control-sm mt-1" placeholder="{{ $data['user']->email }}" name="email" id="email" value="{{ $data['user']->email, old('email') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control form-control-sm mt-1" placeholder="{{ $data['user']->telepon }}" name="telepon" id="telepon" value="{{ $data['user']->telepon, old('telepon') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" class="form-control form-control-sm mt-1" placeholder="{{ $data['user']->data_lahir }}" name="date_lahir" id="date_lahir" value="{{ $data['user']->date_lahir, old('date_lahir') }}" required>
                                            </div>
                                            <div class="col-md-6">
                                                <strong><i class="fas fa-map-marked me-2"></i>Kota Lahir</strong>
                                                <input type="text" class="form-control form-control-sm mt-1" placeholder="{{ $data['user']->kota_lahir }}" name="kota_lahir" id="kota_lahir" value="{{ $data['user']->kota_lahir, old('kota_lahir') }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select form-select-sm mt-1" name="alm_prov_asal" id="alm_prov_asal" value={{ old('alm_prov_asal') }}  aria-label="" required>
                                                        @if ($data['user']->alm_prov_asal != '0')
                                                            <option value="{{ $data['user']->alm_prov_asal }}" selected>{{ $data['alm_wilayah_asal']['prov_asal'] }}</option>
                                                        @endif
                                                        @foreach ($data['provincies'] as $province)
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select form-select-sm mt-1" name="alm_kota_asal" id="alm_kota_asal" aria-label="" required>
                                                        @if ($data['user']->alm_kota_asal != '0')
                                                            <option value="{{ $data['user']->alm_kota_asal }}" selected>{{ $data['alm_wilayah_asal']['kota_asal'] }}</option>
                                                        @else
                                                            <option value="{{ $data['user']->alm_kota_asal }}" selected>Belum terisi</option>
                                                        @endif
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select form-select-sm mt-1" name="alm_kec_asal" id="alm_kec_asal" aria-label="" required>
                                                        @if ($data['user']->alm_kec_asal != 0 )
                                                            <option value="{{ $data['user']->alm_kec_asal }}" selected>{{ $data['alm_wilayah_asal']['kec_asal'] }}</option>
                                                        @else
                                                            <option value="{{ $data['user']->alm_kec_asal }}" selected>Belum terisi</option>
                                                        @endif
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select form-select-sm mt-1" name="alm_kel_asal" id="alm_kel_asal" aria-label="" required>
                                                        @if ($data['user']->alm_kel_asal != 0 )
                                                            <option value="{{ $data['user']->alm_kel_asal }}" selected>{{ $data['alm_wilayah_asal']['kel_asal'] }}</option>
                                                        @else
                                                            <option value="{{ $data['user']->alm_kel_asal }}" selected>Belum terisi</option>
                                                        @endif
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane show " id="alm-domisili" role="tabpanel" aria-labelledby="alm-domisili-tab" tabindex="0">
                                        <div class="row mb-4">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select form-select-sm mt-1" name="alm_prov_domisili" id="alm_prov_domisili" value={{ old('alm_prov_domisili') }}  aria-label="" required>
                                                        @if ($data['user']->alm_prov_domisili != '0')
                                                            <option value="{{ $data['user']->alm_prov_domisili }}" selected>{{ $data['alm_wilayah_domisili']['prov_domisili'] }}</option>
                                                        @else
                                                            <option value="{{ $data['user']->alm_prov_domisili }}">Belum Terisi</option>
                                                        @endif
                                                        @foreach ($data['provincies'] as $province)
                                                            <option value="{{ $province->id }}">{{ $province->name }}</option>
                                                        @endforeach
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select form-select-sm mt-1" name="alm_kota_domisili" id="alm_kota_domisili" aria-label="" required>
                                                        @if ($data['user']->alm_kota_domisili != '0')
                                                            <option value="{{ $data['user']->alm_kota_domisili }}" selected>{{ $data['alm_wilayah_domisili']['kota_domisili'] }}</option>
                                                        @else
                                                            <option value="{{ $data['user']->alm_kota_domisili }}" selected>Belum terisi</option>
                                                        @endif
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select form-select-sm mt-1" name="alm_kec_domisili" id="alm_kec_domisili" aria-label="" required>
                                                        @if ($data['user']->alm_kec_domisili != 0 )
                                                            <option value="{{ $data['user']->alm_kec_domisili }}" selected>{{ $data['alm_wilayah_domisili']['kec_domisili'] }}</option>
                                                        @else
                                                            <option value="{{ $data['user']->alm_kec_domisili }}" selected>Belum terisi</option>
                                                        @endif
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select form-select-sm mt-1" name="alm_kel_domisili" id="alm_kel_domisili" aria-label="" required>
                                                        @if ($data['user']->alm_kel_domisili != 0 )
                                                            <option value="{{ $data['user']->alm_kel_domisili }}" selected>{{ $data['alm_wilayah_domisili']['kel_domisili'] }}</option>
                                                        @else
                                                            <option value="{{ $data['user']->alm_kel_domisili }}" selected>Belum terisi</option>
                                                        @endif
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="card mt-4">
                                    <div class="card-body text-center py-1">
                                        @if ($data['user']->photo == '')
                                            <img type="button" class="profile-user-img rounded-circle img-preview mt-2 mb-3" width="130px" height="130px" data-bs-toggle="modal" data-bs-target="#zoomPhoto" title="Zoom" src="{{ asset('assets/templates/Mantis-Bootstrap-1.0.0/images/user/user_icon.jpg') }}">
                                        @else                                
                ...
                <div class="modal-body">  
                    <div class="row mb-3">
                        <div class="col-md-12 text-center">
                            @if ($data['user']->photo == '')
                                <img  class="profile-user-img img-fluid img-circle imgZoom" src="{{ asset('assets/templates/Mantis-Bootstrap-1.0.0/images/user/user_icon.jpg') }}" style="width:450px;height:450px">
                            @else 
                                {{-- Photo yang diupload untuk diedit  --}}
                                <img class="profile-user-img img-fluid img-circle img-preview" src="{{ asset('storage/usersdata/'.$data['user']->email.'/images/'.$data['user']->photo) }}" style="width:450px;height:450px">
                            @endif
                        </div>
                    </div>
                </div>
