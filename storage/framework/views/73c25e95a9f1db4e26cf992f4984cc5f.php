...
<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
    <div class="loader-bg"><!-- [ Pre-loader ] start -->
        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="../dashboard/index.html" class="b-brand text-primary">
                    ...
                    <img src="<?php echo e(asset('assets/templates/Mantis-Bootstrap-1.0.0/images/logo-icon.svg')); ?>" class="img-fluid" alt="logo">
                </a>
            </div>
            <div class="navbar-content">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <img src="<?php echo e(asset('assets/templates/Mantis-Bootstrap-1.0.0/images/img-navbar-card.png')); ?>" alt="images" class="img-fluid mb-2">
...
<!-- [ Header ] end -->
  ...
  <footer class="pc-footer">
    ...
    <script src="<?php echo e(asset('assets/templates/Mantis-Bootstrap-1.0.0/js/plugins/apexcharts.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/templates/Mantis-Bootstrap-1.0.0/js/pages/dashboard-default.js')); ?>"></script>
...
</html><?php /**PATH C:\Apache24\htdocs\My_Project\laravel-12\resources\views/dashboard/index.blade.php ENDPATH**/ ?>